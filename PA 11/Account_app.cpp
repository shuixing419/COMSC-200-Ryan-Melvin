#include <iostream>
#include <iomanip>
#include "Jie_Zhou_Account.h" // Account class definition
#include "Jie_Zhou_SavingsAccount.h" // SavingsAccount class definition
#include "Jie_Zhou_CheckingAccount.h" // CheckingAccount class definition
using namespace std;

int main()
{
   Account account1( 680.0 ); // create Account object
   SavingsAccount account2( 480.0, .03 ); // create SavingsAccount object
   CheckingAccount account3( 800.0, 1.0 ); // create CheckingAccount object
